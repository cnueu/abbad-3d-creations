...
export const translations: { en: Dict; ar: Dict } = {
  en: {
    ...
    store: {
      ...
      cubeDesc: "Precision modular cube. Six faces, four channel slots per face for our connector sheets. Snap together to build anything. Connector sheets are included free with every cube order — you only need extras for advanced builds.",
      sheetDesc: "Two-piece interlocking connector sheet. Slides between two cubes (2cm root × 1.41cm edge × 0.989cm tip × 10cm long). Sheets are already included with your cubes — order these only if you need extras.",
      close: "Close",
      sheetTitle: "Connector Sheet",
      sheetSize: "20cm × 2cm × 1.25cm",
      includesNote: "Sheets included free: each cube comes with the connectors needed for a basic build.",
      includesFormula: "For {n} cubes you get {s} connector sheets included free.",
      extraSheetsTitle: "Extra connector sheets",
  ...
  ar: {
    ...
    store: {
      ...
      price: "السعر",
      description: "الوصف",
      cubeDesc: "مكعب وحدة دقيق بستة أوجه وأربع شقوق في كل وجه لصفائح الربط. ركّب أي شيء. صفائح الربط مرفقة مجاناً مع كل طلب مكعبات — لن تحتاج لشرائها إلا للتركيبات المتقدمة.",
      sheetDesc: "صفيحة ربط من قطعتين متداخلتين، تنزلق بين مكعبين (2سم قاعدة × 1.41سم حافة × 0.989سم رأس × 10سم طول). تأتي مجاناً مع المكعبات — اطلبها فقط إذا أردت قطعاً إضافية.",
      close: "إغلاق",
      sheetTitle: "صفيحة الربط",
      sheetSize: "20سم × 2سم × 1.25سم",
      includesNote: "صفائح ربط مجانية: كل مكعب يأتي مع ما يكفيك من الموصِّلات للبناء الأساسي.",
      includesFormula: "مع {n} مكعب تحصل على {s} صفيحة ربط مجاناً.",
      extraSheetsTitle: "صفائح ربط إضافية",
